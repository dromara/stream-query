...
class TreeHelperTest {
  ...
  void testToTreeAndLevel() {
    ...
    Assertions.assertEquals(
        treeByLevelOriginStudentTree, conditionTreeHelper.getTreeByLevel(originStudentList, 2));
    Assertions.assertEquals(
        treeFromRootToLevelOriginStudentTree, conditionTreeHelper.toTree(originStudentList, 1));
  }
