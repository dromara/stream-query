...
public interface SerBiCons<T, U> extends BiConsumer<T, U>, Serializable {
  ...
  /**
   * Returns a composed {@code SerBiCons} that performs, in sequence, this operation followed by the
   ...
   * @return a composed {@code SerBiCons} that performs in sequence this operation followed by the
