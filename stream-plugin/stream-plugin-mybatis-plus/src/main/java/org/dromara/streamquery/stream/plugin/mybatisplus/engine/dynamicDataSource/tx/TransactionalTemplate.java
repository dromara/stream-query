...
import org.dromara.streamquery.stream.plugin.mybatisplus.engine.dynamicDataSource.datasource.exception.TransactionException;
...
public class TransactionalTemplate {
  ...
  private Object doExecute(TransactionalExecutor transactionalExecutor) throws Throwable {
    ...
    if (!DsStrUtils.isEmpty(TransactionContext.getXID())
        && !propagation.equals(DsPropagation.NESTED)) {
      return transactionalExecutor.execute();
    }
    boolean state = true;
    Object o;
