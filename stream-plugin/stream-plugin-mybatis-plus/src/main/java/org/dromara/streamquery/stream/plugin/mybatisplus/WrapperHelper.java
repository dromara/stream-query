...
public class WrapperHelper {
    ...
    public static <T> LambdaQueryWrapper<T> multiIn(LambdaQueryWrapper<T> wrapper, List<T> dataList) {
        ...
        multiOr(wrapper, fieldList, (w, tableField) -> {
     ...
     * @return 条件构造器
     */
    public static <W extends AbstractWrapper<T, ?, W>, T, R>
    W multiOr(W wrapper, Collection<R> dataList, BiConsumer<W, R> biConsumer) {
        if (Lists.isEmpty(dataList)) {
