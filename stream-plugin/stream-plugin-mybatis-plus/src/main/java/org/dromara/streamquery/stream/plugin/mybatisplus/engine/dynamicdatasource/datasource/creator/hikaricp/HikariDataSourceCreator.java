 ...
 */
package org.dromara.streamquery.stream.plugin.mybatisplus.engine.dynamicdatasource.datasource.creator.hikaricp;
...
public class HikariDataSourceCreator implements DataSourceCreator {
  ...
  /**
   * to support springboot 1.5 and 2.x HikariConfig 2.x use 'copyState' to copy config HikariConfig
   * 3.x use 'copyStateTo' to copy config
   */
