...
import org.dromara.streamquery.stream.plugin.mybatisplus.engine.dynamicdatasource.tx.ConnectionFactory;
import org.dromara.streamquery.stream.plugin.mybatisplus.engine.dynamicdatasource.tx.ConnectionProxy;
import org.dromara.streamquery.stream.plugin.mybatisplus.engine.dynamicdatasource.tx.TransactionContext;
...
public abstract class AbstractRoutingDataSource extends AbstractDataSource {
  ...
  public Connection getConnection() throws SQLException {
    ...
    if (DsStrUtils.isEmpty(xid)) {
      ...
      return connection == null
          ? getConnectionProxy(xid, ds, determineDataSource().getConnection())
          : connection;
    }
  }
  ...
  public Connection getConnection(String username, String password) throws SQLException {
    ...
    if (DsStrUtils.isEmpty(xid)) {
      ...
      ConnectionProxy connection = ConnectionFactory.getConnection(xid, ds);
      return connection == null
          ? getConnectionProxy(xid, ds, determineDataSource().getConnection(username, password))
          : connection;
    }
  }
