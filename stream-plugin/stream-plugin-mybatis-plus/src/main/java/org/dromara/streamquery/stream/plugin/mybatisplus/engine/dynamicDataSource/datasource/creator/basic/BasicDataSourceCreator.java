 ...
 */
package org.dromara.streamquery.stream.plugin.mybatisplus.engine.dynamicDataSource.datasource.creator.basic;
...
public class BasicDataSourceCreator implements DataSourceCreator {
  ...
  static {
    ...
    if (builderClass == null) {
      try {
        builderClass =
            Class.forName("org.springframework.boot.autoconfigure.jdbc.DataSourceBuilder");
      } catch (Exception e) {
