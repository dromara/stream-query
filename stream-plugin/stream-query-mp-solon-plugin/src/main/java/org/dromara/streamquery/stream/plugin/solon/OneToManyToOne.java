...
public class OneToManyToOne<
   ...
   *
   * @param middleKey a {@link SFunction} object
   */
   ...
   * value.
   *
   * @param middleValue a {@link SFunction} object
   * @param <VV> a VV class
   * @return a {@link OneToManyToOne} object
   */
   ...
   * attachKey.
   *
   * @param attachKey a {@link SFunction} object
   * @param <UU> a UU class
   * @return a {@link OneToManyToOne} object
   */
   ...
   * attachValue.
   *
   * @param attachValue a {@link SFunction} object
   * @param <AA> a AA class
   * @return a {@link OneToManyToOne} object
   */
   ...
   * condition.
   *
   * @param queryOperator a {@link UnaryOperator} object
   * @return a {@link OneToManyToOne} object
   */
   ...
   * attachCondition.
   *
   * @param attachQueryOperator a {@link UnaryOperator} object
   * @return a {@link OneToManyToOne} object
   */
   ...
   * query.
   *
   * @param mapper a {@link BiFunction} object
   * @param <R> a R class
   * @return a R object
   */
